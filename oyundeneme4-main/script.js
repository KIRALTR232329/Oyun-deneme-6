...
// Create a function to add the audio element to the DOM and play it
function playAudio() {
  ...
  sourceElement.src = "sounds/girisSesi.mp3";
  sourceElement.type = "audio/mpeg";
  
  // Append source element to audio element
  audioElement.appendChild(sourceElement);
  
  // Append audio element to the body or any other element in your HTML
